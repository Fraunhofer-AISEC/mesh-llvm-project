...
set(ALL_MESH_SUPPORTED_ARCH ${X86_64} ${ARM64})
...
if(APPLE)
  ...
  list_intersect(MESH_SUPPORTED_ARCH
    ALL_MESH_SUPPORTED_ARCH
  ...
  filter_available_targets(UBSAN_COMMON_SUPPORTED_ARCH
    ${SANITIZER_COMMON_SUPPORTED_ARCH})
  filter_available_targets(MESH_SUPPORTED_ARCH ${ALL_MESH_SUPPORTED_ARCH})
...
set(ALL_SANITIZERS mesh;asan;dfsan;msan;hwasan;tsan;safestack;cfi;scudo;ubsan_minimal;gwp_asan)
...
if (COMPILER_RT_HAS_SANITIZER_COMMON AND MESH_SUPPORTED_ARCH AND
    OS_NAME MATCHES "Linux|Darwin")
  set(COMPILER_RT_HAS_MESH TRUE)
else()
  set(COMPILER_RT_HAS_MESH FALSE)
endif()
